CREATE TEMPORARY VIEW audit_document_retrieve
AS
(SELECT 
-- audit event fields
...
WHERE event.event_type_code = 'EV("ITI-39", "IHE Transactions", and "Cross Gateway Retrieve")'
...
\copy (SELECT * from audit_document_retrieve) TO 'document_retrieve.csv' DELIMITER ',' CSV HEADER;